...
MQTT_TOPIC = "sensor/Infrarrojo"
MQTT_PORT = 1883

# Configurar el sensor infrarrojo (JY-005) con pull-up interno
ir_sensor = Pin(4, Pin.IN, Pin.PULL_UP)  # Usar PULL_UP para evitar flotación del pin
...
while True:
    ...
    if estado == 1:  # Algunos sensores infrarrojos son activos bajo (LOW = detecta objeto)
        ...
        print("Sin detección de objeto")
        if client:
            client.publish(MQTT_TOPIC, "Sin detección de objeto")
